...
url: "encounters-protocol-configuration-and-programming.md"
...
More help regarding other details of flowsheet module programming is found in [Observation Flowsheets](observation-flowsheets.md) help guide in the {{% system-name %}} online help.
