...
url: "alerts-errors-failures-interactive-tab.md"
author: Alan Quandt
...
If you click the *Manage Information* icon, it will take you to the Fax Manager tab. This is where you can then see the ERROR FAX SPOOL category and listing in full and other specific options to work the failed fax. For more information on this screen and how to work failed faxes, see our [Fax Manager Tab-Outbound Faxing](fax-manager-tab-outbound-faxing.md) help documentation.
