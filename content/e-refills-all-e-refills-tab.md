...
url: "e-refills-all-e-refills-tab.md"
...
![](external_files/7d2b1f510a3558762ffa53624b4431cb.png)
...
![](external_files/783095e7af8280fa5bded4276f5c64a6.png)

{{% tip %}}

If you are receiving e-refill requests from pharmacies for a physician who has left your practice, please see other help documentation named [Setting Up E-Prescribers](setting-up-e-prescribers.md). That help documentation will guide you to make sure to follow the steps on how to correctly edit the username screen for that physician from {{% system-name %}} and terminate them from being certified with SureScripts from your practice and so SureScripts will know to disable them and pharmacies will remove them from sending refill requests to your practice.
...
![](external_files/9d7aa4ff6560d3cbb5745f487fe2de29.png)
...
![](external_files/67d0b4f074c74ca9e01ce60dbe29c615.png)
...
![](external_files/8961a7cfb5da940b687599072549dfe6.png)
...
![](external_files/982edd39d804cd94854f92313c6795a2.png)

You can also get to the RESEND button by clicking on the specific refill *ID* link.

![](external_files/7c40b4884397e5b2be0013ab14589d49.png)

![](external_files/d0b9ef616b06fab43045a8ac1b823e35.png)
...
![](external_files/57e42ea216a44f9cc01ecc1bb8e3a1c5.png)
