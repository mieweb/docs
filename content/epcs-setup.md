...
* 61 incomplete Install the SafeNet Authentication Client Software (on ALL workstations being used for EPCS). 
...
![](external_files/0e67e15bcd12279171e93e3c1157a676.png)
...
{{% tip %}} If the prescribing clinician is new to {{% system-name %}} , click the **Add User** link, to add the user/provider to the {{% system-name %}} solution. See [User/Provider & Department Management](user-provider-and-department-management.md) for more information on adding users/providers. {{% /tip %}}
...
{{% info %}}When the EPCS option is selected by the Designated Administrator, the following pop-up will display, prompting for the insertion of the two-factor authentication credential, followed by the password: ![](external_files/4e3742e0acdf7e01b1d098799253413d.png){{% /info %}}
...
![](external_files/3f8aa7473e3d421d0bcb03b101d31728.png)

![](external_files/dd3622d4b30963fed85a9ec6df0739ca.png)
...
![](external_files/926d6bd3cdde93841eeba638ed63c6c7.png)
...
![](external_files/f5e1341c03457e2d5a19cc3334f13fc0.png)

![](external_files/8a9a3ebc52d47a4f375e87e71c92312f.png)
...
![](external_files/44973025498044b25c8c22e62fe9270b.png)
...
![](external_files/f3bb52c9597bdba9b2c35506837dced9.png)
...
![](external_files/dac9acba2ca780ec379056fc77a2051c.png)
...
![](external_files/0f77c18140aaa24203ef799fb28cd49a.png)
...
![](external_files/101a70cec6edd146b72e2b04adb328bd.png)
...
* For more information, refer to our [Print/Fax/Transmit Prescriptions](print-fax-transmit-prescriptions.md) and [E-Meds Report](e-meds-report.md) help documentation. 

**Audit Event Log**

* All EPCS-related activity displays under <strong>EPCS Event Description</strong>.
* For more information, refer to our [View User Audit Log](view-user-audit-log.md) help documentation.
