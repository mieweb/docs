...
url: "access-control-quick-add-multiple-active-users.md"
author: Alan Quandt
...
You can quickly tag multiple users to a specific department by going to "View Department" and using the listedit & autocomplete feature there. See help documentation titled [Managing Departments](managing-departments.md) for more information.
