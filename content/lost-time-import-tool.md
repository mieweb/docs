...
,N/A</td>
  ...
  <tr>
    ...
    <td>,Recommended Field, Maps to ,{{% system-name %}}, incident field "Privacy Case" checkbox. Flag if incident is sensitive. Name of employee is hidden on OSHA log. Options include:
,1 - yes
,0 - no</td>
    <td>1</td>
    <td>1</td>
