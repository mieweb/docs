...
url: "user-provider-and-department-management.md"
author: Alan Quandt
...
**Edit Patients Linked to User** is most often used with regard to Portal management and use. For further instructions on how to use this feature, review the [Linking Users portal documentation](linking-users-for-portal-access.md).
