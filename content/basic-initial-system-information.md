...
url: "basic-initial-system-information.md"
...
* Users can view the help document named [My Settings](my-settings.md) that will explain every setting present on the screen.
