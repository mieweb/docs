...
---
Beginning in the 202403 release, users will no longer be able to click on the Allergy/Intolerance Encounter section and add/edit allergies in legacy mode. Users must use the new quick links, located on the right-hand side of the encounter section to add/edit allergies.
...
Previously added notes on the allergy/intolerance will be dated and displayed in gray under the ‘add new note' entry box upon editing or adding additional notes.
