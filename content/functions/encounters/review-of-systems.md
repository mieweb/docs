...
Within the Review of Systems encounter section, there is an icon that offers _Copy from Previous Exam_ functionality.

![](./review-of-systems.assets/7117c781b4040749e87c276ff8358b1b.png)

The _Copy from Previous Exam_ icon pops up a window to allow you to select Review of Systems field data that you wish to copy from the chart's prior encounter(s) to this current encounter.
