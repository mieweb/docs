...
When working in any encounter, there is a _Presenting Restrictions_ encounter section available. By default, this lists all presenting restrictions along with any accommodations in a summary format and is security permission dependent.
...
{{% note %}}
Restrictions cannot be added nor updated nor deleted from the Presenting Restrictions encounter section.  You must jump to the separate encounter section named _Restrictions_ within the Plan to edit, add or delete restrictions on a chart.
{{% /note %}}
