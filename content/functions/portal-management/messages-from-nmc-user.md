...
![](../messages-from-nmc-user.assets/1000000000000389000001BCC44A11D0AF5576E7.png)  
...
![](../messages-from-nmc-user.assets/10000000000003E00000018B9BF6139B36CF1C20.png)  
...
![](../messages-from-nmc-user.assets/100000000000036E000000455F5B5F3C02418B0C.png)  
...
![](../messages-from-nmc-user.assets/1000000000000379000002059CF3B3E8710053F3.png)  
...
![](../messages-from-nmc-user.assets/100002010000043F000002583EE38EFB19D45C2A.png)  
...
![](../messages-from-nmc-user.assets/10000201000002D300000094D5E7CBA5E8C3D7E7.png)  
...
![](../messages-from-nmc-user.assets/1000000000000343000001125CB3E142BBA0D258.png)  
...
![](../messages-from-nmc-user.assets/100000000000037F00000107B1A1D7599C534FCC.png)  
...
![](../messages-from-nmc-user.assets/1000000000000371000000C8EBBF90420C58F18E.png)  
...
![](../messages-from-nmc-user.assets/10000000000003850000006265DF8A347F5E1459.png)  
...
![](../messages-from-nmc-user.assets/100000000000034E0000004C669DA1C3C88FD21F.png)  
...
![](../messages-from-nmc-user.assets/100002010000052C0000022C62772878329216FC.png)  

**"Deactivate"** means that you no longer want the error to be sent and to never try again. **"Acknowledge"** means that you know there was an error, you no longer want to see it on the send queue but if the information, document, patient info ever changes, the information will be resent. **"Resend"** will attempt to resend that data message again.
  
![](../messages-from-nmc-user.assets/10000201000004BF000001BD1471DBE3EA58F894.png)  
...
![](../messages-from-nmc-user.assets/10000201000004CF0000014E657B291BE3E18001.png)  
...
![](../messages-from-nmc-user.assets/1000000000000446000000A9ED0443FC0B19EBB5.jpg)  
...
![](../messages-from-nmc-user.assets/10000201000003810000009F0A95EDF683689F95.png)  
...
![](../messages-from-nmc-user.assets/100000000000037400000136B814A4C8C10CF013.png)  
...
![](../messages-from-nmc-user.assets/10000000000003C2000001DAAE0C5FE757D3DC16.png)  
...
![](../messages-from-nmc-user.assets/100000000000035F0000005E5D944C4B3F6DA443.png)  
...
![](../messages-from-nmc-user.assets/100000000000037F0000017AE3750ECADD8A9731.png)  
...
![](../messages-from-nmc-user.assets/10000000000003750000013A706B4C0EA07937EF.png)  
...
![](../messages-from-nmc-user.assets/10000000000002DC00000163AB06B40ACF594A68.png)  
...
![](../messages-from-nmc-user.assets/10000000000002AD000001E8493061F01AC964EC.png)  
...
![](../messages-from-nmc-user.assets/10000000000003DB00000138F01C37386F991AE8.png)  
...
![](../messages-from-nmc-user.assets/10000000000003910000014901A8278E463E8FD1.png)  
...
![](../messages-from-nmc-user.assets/10000000000001E0000000F0F6375B0BF1339F5E.jpg)  
...
![](../messages-from-nmc-user.assets/10000000000003520000006E370A7D766591437F.jpg)  
...
![](../messages-from-nmc-user.assets/100002010000039D000001FB8CDC5D2DF9B9E74D.png)  
...
![](../messages-from-nmc-user.assets/100000000000038600000135C48A1F4E12D13DBA.png)  

Once you have sent the patient summary to the NMC user from {{% system-name %}} using that button, it will tell you the document number and a message that it was uploaded successfully into the NMC user's account. If the patient doesn't have an NMC account yet, it will provide you with the member pickup code that you can give to the patient. They would then log into NoMoreClipboard, create an account and use that member pickup code. Once the promo code is picked up (patient creates a NMC account) then the promo code is removed. Any future pushes would not return a promo code, just the confirmation that the document was posted to NoMoreClipboard. The NMC# is not known to the {{% system-name %}} system until the NMC patient sends something back to the {{% system-name %}} system. This is why you still see the message "*a NoMoreClipboard.com account is not linked to this patient"*, but you are not getting a promo code back either.
  
![](../messages-from-nmc-user.assets/1000000000000313000000CEA7F4E45E934507AF.jpg)  
...
![](../messages-from-nmc-user.assets/100000000000031B0000005DCBFF0210B325BA85.png)  
...
![](../messages-from-nmc-user.assets/100000000000039400000200C2A06DFE261E8FB6.png)  
...
![](../messages-from-nmc-user.assets/10000201000004AB000000C8E0CC6BDD1F3BBF81.png)  
...
![](../messages-from-nmc-user.assets/10000201000004CA000001507C2264DFDB042E3A.png)  
...
![](../messages-from-nmc-user.assets/10000201000003CD0000008E7620045FEC3FFD1F.png)  
...
![](../messages-from-nmc-user.assets/1000020100000356000000C524AA1E47EEE5DAEB.png)  
