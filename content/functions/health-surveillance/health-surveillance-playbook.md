...
3. Make sure only the desired panel to be exported is selected. This ensures all other panels do not copy, avoiding the extra work of having to de-select any unwanted panels. ![](../health-surveillance-playbook.assets/55eec80228b6a0a266a36eab7055df62.png)
{{% /tip %}}
