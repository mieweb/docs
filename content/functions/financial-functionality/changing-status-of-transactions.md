...
4. To change the status of transactions:
    ...
    2. To change the status of the selected transactions to "cleared," select the <strong>Set Cleared</strong> button. The system displays "cleared" in the <em>STATUS</em> column of the transactions.<img src="changing-status-of-transactions.assets/100000000000017200000025CAB39488E0602DFF.png" />
