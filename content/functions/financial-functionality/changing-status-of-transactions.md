...
4. To change the status of transactions:
   ...
   2. To change the status of the selected transactions to "cleared," select the <strong>Set Cleared</strong> button. The system displays "cleared" in the <em>STATUS</em> column of the transactions.![](../changing-status-of-transactions.assets/9f90528398346626c664de4e96433e1a.png)
