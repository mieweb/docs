...
**Name:** **Rxdb_utf8****:** is a hyperlink that can be clicked to see the RXDB Section Update Summary.

![](./first-databank-and-rxdb-database-last-update-and-version.assets/7d67821d44ee19d0ba7adec9b848353c.png)

The summary screen then lists data sets on our servers that are utilized, along with dates of last updates.

![](./first-databank-and-rxdb-database-last-update-and-version.assets/340a057d7b3944dfc5d86de494908916.png)

**Version:** This shows the version number of the RXDB database being used in the system.  This version number is also visible in the rxdb_utf8 hyperlink details screen for RXDB Last Updated & Version.
