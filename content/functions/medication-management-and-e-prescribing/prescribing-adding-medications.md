...
* <strong>Clear:</strong> Clicking this button will clear out <em>all</em> fields for this specific prescription. This is a quick way to clear the fields to start over if you realize that you made a mistake and want to start over (before clicking the ‘prescribe' function button).![](../prescribing-adding-medications.assets/ac485113b110851e5cd795afc63f1ede.png)
...
![](../prescribing-adding-medications.assets/8cff1768cbf7d3085ad56613d3068f0d.png) ![](../prescribing-adding-medications.assets/dffda9121afca8433a6c2243df504b19.png)
