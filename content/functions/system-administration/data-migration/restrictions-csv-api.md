...
url: "functions/system-administration/data-migration/restrictions-csv-api.html"
author: aquandt
version: 16
...
menu:
    main:
        ...
        weight: 5080
---
The following page defines data and fields that may be imported into MIE systems (WebChart, Enterprise Health) **for restrictions** using the [Case Management CSV API](case-management-csv-api.html).
...
[Case Management CSV API specifications are available here](https://docs.google.com/spreadsheets/d/1sLE0ZxfpH27FOIiEUo2YrNfmmI7L-6MWS1aTJu7sVHM/edit#gid=1771472836|The).
