...
url: "functions/system-administration/data-migration/case-management-csv-api.html"
author: aquandt
version: 18
...
* [Conditions Case Management CSV API](conditions-csv-api.html)
* [Nature of Injury Case Management CSV API](nature-of-injury-csv-api.html)

The Case Management CSV API includes encounter information, but a separate CSV API--[Clinical Encounter CSV API](clinical-encounter-csv-api.html) is used when encounters are not imported as a part of a case.
...
The [Clinical Encounter CSV API](clinical-encounter-csv-api.html) imports case-related data, such as how and where an injury occurred, but does not include data on how a workplace accommodates an injury. An incident is not required for an encounter.
