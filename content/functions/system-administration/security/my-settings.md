...
* AC Name Search Method:  Last,First set as default. This is how you search for a patient by name in any autocomplete search fields. This only works in autocomplete name search fields. You can opt to default this to FLast which is first initial immediately followed by last name  ex: dduck (Daffy Duck)
