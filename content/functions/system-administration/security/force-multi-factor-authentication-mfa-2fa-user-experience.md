...
![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/a416973d22722cc88949dc844cf2813d.png)
...
![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/cbd926de5557886a5334fce43eec1a6c.png)
...
![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/3225dc12200ab4b444283e5ead4175b1.png)
...
![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/d61d4ff2d87469c31b58301f8c95ded9.png)
...
![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/57d05d3b7428ab161d3ebf52706571ee.png)
...
![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/a0e155f059e5f5baf070cc58bc3f12c1.png)
...
![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/464cd8281e802c68d412a5e3cb3c6bff.png)

The {{% system-name %}} system will generate a unique QR code and displays that on the next screen upon clicking the *Create* button.

![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/d7e186bb1bde2f094fc409ff73e8e591.png)
...
![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/6bb61372f006643a2f0bb0c5fb534dd8.png)
...
![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/fe8437b07508a101d78b752f190fa468.png)

Go back to  {{% system-name %}} system screen and *Enter the OTP from your device*.  Next, click the *Complete Setup* button.

![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/5ba46b0e60c66685873a1eebd99c3876.png)

If successful, you will see that your 2 Step Verification setup is now complete.  Click the *Continue* button.

![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/207c281f1a88463ecbf8b9e2a7aeadd7.png)
...
![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/164dabfb2dd11ead2fbcdff8e9fac419.png)
...
![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/23226df367e8b2c609c9fd8032dc94fd.png)

The user would open up their authenticator app on their other device, get the random generated 6 digit OTP from their authenticator app, and key it into the {{% system-name %}} system *extra authentication needed* screen.

![](../force-multi-factor-authentication-mfa-2fa-user-experience.assets/de79e2aa6a3f7a0fe250f0a23c44ae3a.png)
