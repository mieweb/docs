...
url: "functions/system-administration/system-controls/limited-access-users.html"
version: 28
...
![](limited-access-users.images/image1.png)
...
If the patient's chart is "locked", you cannot link that patient to a user that doesn't have permission to that locked chart. (See other help documentation named [Locking Individual or Specific Charts ](locking-individual-or-specific-charts.html))
...
![](limited-access-users.images/image4.png)
