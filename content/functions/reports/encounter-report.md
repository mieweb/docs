...
Click the _Visits_ tab from the top tab menu and select the _Encounter Report_.
...
When searching for a specific encounter by encounter ID field, it is _not_ a "starts as" type of search. You cannot find encounter ID's beginning with the number you start typing. You have to type the whole encounter ID to get a result.
