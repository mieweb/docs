...
**Patient**: Searching can be narrowed down to a specific patient/chart, MRN, Date of Birth, or SSN. For more information on how to utilize the autocomplete search, click the help bubble ![](batch-search-in-webscan.assets/1000020100000001000000014C77D75F6DC67A52.png) to the right of the field.
