...
Within the _Add Documents_ screen, simply filter by File. This will display the File Upload screen, where you can upload a file to be inserted into the chart.
...
Users may then select the _Upload Document_ button to upload all document(s)/file(s) into the chart at once.
