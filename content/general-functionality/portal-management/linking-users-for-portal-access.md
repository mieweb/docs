...
url: "general-functionality/portal-management/linking-users-for-portal-access.html"
version: 43
...
{{% tip %}} To remove a role from the table, utilize the minus [ - ] button. After all changes are made, click the **Submit** button. {{% /tip %}}
