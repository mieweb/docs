...
url: "general-functionality/system-administration/system-controls/access-control-adding-deleting-editing-u.html"
author: aquandt
version: 51
...
Click the Add User link on the far right side. (To add multiple active users quickly at a time, see other help documentation named [Access Control-Quick Add Multiple Users](access-control-quick-add-multiple-active.html))
