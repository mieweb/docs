...
**Description**
    ...
    <td>
**Value Type **(O=Optional, R=Required, Rv=Required to be the value listed)

    </td>
    <td>
**Sample or Required Values**
...
f
    ...
    <td>
Tells system you are requesting to do an HL7 upload.
...
interface
    ...
    <td>
Tells system the name of the configuration to use.
...
login_user
    ...
    <td>
Username assigned to your posting account
...
login_passwd
    ...
    <td>
Password assigned to your posting account
