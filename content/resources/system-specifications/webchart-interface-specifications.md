...
links:
  ...
  - '../../features/system-administration/interfaces/e-clinicalworks.md'
...
WebChart Interface Specifications

The list below represents a complete listing of all vendors/devices that we have integrated with. Any vendor/device not listed would need to be researched for compatibility with our product. Check out our [additional documentation](../../features/system-administration/interfaces/sending-hl7-messages-to-system.md) that explains how to send HL7 messages to us.

## Standard Interfaces

* [Direct Project](http://wiki.directproject.org/) and S/MIME
* [HL7](../../features/system-administration/interfaces/sending-hl7-messages-to-system.md)
* [DICOM](../../features/document-management/imaging/dicom-setup-tab.md)
* XDS
...
* Audiometer
    * [Amplivox CA850 & PC850 USB](../../features/system-administration/interfaces/device-interface-amplivox-ca850.md) (File Bi-directional) - Sends data to the device and then data is automatically uploaded back to Enterprise Health using the device app
    * [Benson CCA-100mini Plus Industrial Audiometer with a BAS-200 Bio-Acoustic Simulator](../../features/system-administration/interfaces/device-interface-benson-audiometer.md), [Benson Mini CCA-200mini](../../features/system-administration/interfaces/device-interface-benson-audiometer.md) (requires Plus Package software) (File Bi-directional)
    ...
    * [Benson 200](../../features/system-administration/interfaces/device-interface-benson-audiometer.md) Audiometer Device - requires the PLUS package
    ...
    * [Maico MA800](../../features/system-administration/interfaces/device-interface-maico-ma800.md) (Serial Uni-directional)
    * Monitor Instruments MI5000, MI5000B, [MI7000](../../features/system-administration/interfaces/device-interface-mi-7000.md) (Serial Uni-directional)
    ...
    * [Tremetrics RA300, RA400, RA500, RA660, RA800](../../features/system-administration/interfaces/device-interface-tremetrics-ra500-ra300-ra800.md) (Serial Uni-directional)
    * [Tremetrics RA660](../../features/system-administration/interfaces/device-interface-tremetrics-ra500-ra300-ra800.md) (File Bi-directional) - Sends data to the device and then data is automatically uploaded back to Enterprise Health using the device app
...
* ECG/EKG
    ...
    * [Welch Allyn PC-based Resting ECG Monitoring (CardioPerfect)](../../features/system-administration/interfaces/device-interface-welch-allyn-cardioperfect.md) (ActiveX/File) - Connects to the CardioPerfect software to interface with the device.  Demographic information can be sent to CardioPerfect software and then a file is uploaded to Enterprise Health.  Requires ActiveX control to send demographic information
...
* Spirometer
    ...
    * [NDD EasyOne using EasyOn software](../../features/system-administration/interfaces/device-interface-ndd-easyone-connect-vbase.md) (Direct Communication) - Bidirectional interface with direct communication to Enterprise Health from the EasyOn software
    ...
    * [Welch Allyn CardioPerfect](../../features/system-administration/interfaces/device-interface-welch-allyn-cardioperfect.md) PC-based SpiroPerfect Spirometer (ActiveX / File) - Connects to the CardioPerfect software to interface with the device.  Demographic information can be sent to CardioPerfect software and then a file is uploaded to Enterprise Health.  Requires ActiveX control to send demographic information
    * WINDx (in progress)
* Stress Treadmill
