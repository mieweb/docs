...
<tr>
<td>Deployment</td>
<td><ul><li><p>Easy deployment - 8 to 24 hours, and your {{% system-name %}} system is up and running ready for production</p></li></ul></td>
...
<td><ul><li><p>Infrastructure may not support {{% sys-name %}} requirements</p></li><li><p>May require additional resources to support {{% system-name %}} system</p></li><li><p>Capacity planning may require the provisioning of additional costly hardware or reconfiguration</p></li></ul></td>
</tr>
<tr>
