...
url: "cms-130-colorectal-cancer-screening.md"
author: Alan Quandt
...
* <strong>Option 4: Scan/Index or Upload an accepted screening document</strong>
    * Using [WebScan](scanning-and-indexing.md), scan and index the appropriate document type configured with the necessary LOIN-C.
