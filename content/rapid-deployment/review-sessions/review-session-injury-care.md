...
Direct transmission of OSHA data to the OSHA website is currently on the development roadmap. The first phase will consist of establishing an interface with OSHA, to begin transmitting the OSHA 300A data. The second phase will then include OSHA 300 and OSHA 301 data.
...
* [Cases-Adding Absence Management Case](../../functions/injury-care/case-management/adding-absence-management-case.html)
* [Cases-Adding Hospital Case](../../functions/injury-care/case-management/adding-hospital-case.html)
* [Cases-Adding MSEA Case](../../functions/injury-care/case-management/adding-msea-case.html)
* [Cases-Adding Non-OSHA Case](../../functions/injury-care/case-management/adding-non-osha-case.html)
* [Cases-Adding OSHA Case](../../functions/injury-care/case-management/adding-osha-case.html)
* [Cases-Closing An Existing Case](../../functions/injury-care/case-management/closing-an-existing-case.html)
* [Cases-Deleting An Existing Case](../../functions/injury-care/case-management/deleting-an-existing-case.html)
* [Cases-Viewing](../../functions/injury-care/case-management/viewing-cases.html)
* [Common Case Search Report](../../functions/reports/common-case-search-report.html)
* [Data Import-Lost Time Import Tool](../../functions/system-administration/data-migration/lost-time-import-tool.html)
