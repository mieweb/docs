...
links:
  ...
  - '../../features/encounters/encounter-plan-section-medications.md'
...
{{% info %}}
If the prescribing clinician is new to {{% system-name %}} , click the [Add User link](https://system/?f=admin&t=security&tabmodule=admin&tabselect=Access+Control&opp=auser&realm), to add the user/provider to the {{% system-name %}} solution. See [User/Provider & Department Management](../../features/system-administration/system-controls/user-provider-and-department-management.md) for more information on adding users/providers.
{{% /info %}}
...
* [Encounters Plan Section-Meds](../../features/encounters/encounter-plan-section-medications.md)
* [Allergies and Intolerances](../../features/medication-management-and-e-prescribing/allergies-and-intolerances.md)
* [Discontinue Meds](../../features/medication-management-and-e-prescribing/discontinue-medications.md)
...
* [Edit or Change Meds](../../features/medication-management-and-e-prescribing/edit-change-medications.md)
* [Flow-Pat Ed-Meds Sheets](../../features/medication-management-and-e-prescribing/allergy-medication-tab-quick-links.md)
* [Formulary and Dosing-SureScripts Advanced](../../features/medication-management-and-e-prescribing/surescripts-advanced-formulary-and-dosing.md)
* [Medication History Reconciliation-SureScripts Advanced](../../features/medication-management-and-e-prescribing/surescripts-advanced-medication-history-reconciliation.md)
* [Meds Library-Remembered Scripts](../../features/medication-management-and-e-prescribing/remembered-prescriptions-and-meds-library.md)
* [Meds Tab Summary View](../../features/medication-management-and-e-prescribing/allergies-medications-tab-summary-view.md)
* [Preferred Pharmacy-Supply-Verification-Current Library](../../features/medication-management-and-e-prescribing/setting-preferred-pharmacy-days-supply-and-current-library-and-med-history-verification.md)
* [Prescribing and Adding Meds](../../features/medication-management-and-e-prescribing/prescribing-adding-medications.md)
* [Prescription and Insurance Eligibility Requests-SureScripts Advanced](../../features/medication-management-and-e-prescribing/surescripts-advanced-prescription-and-insurance-eligibility-requests.md)
* [Print-Fax-Transmit Prescriptions](../../features/medication-management-and-e-prescribing/print-fax-transmit-prescriptions.md)
* [Refill All Meds](../../features/medication-management-and-e-prescribing/refill-all.md)
* [Setting up E-Prescribers](../../features/system-administration/system-controls/setting-up-e-prescribers.md)
* [Unknown Allergy or Medication Add Email Notifications](../../features/medication-management-and-e-prescribing/unknown-allergy-medication-email-notifications.md)
