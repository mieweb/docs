...
For more information, check out the [Patient Summary](../../features/e-chart/patient-summary-interactive-chart-tab.md) documentation.
...
For additional details, check out the help documentation on the [Label Printing Feature](../../features/document-management/printing-and-print-definitions/label-printing-feature.md).
...
{{% info %}}
If set up with an orders interface with a lab vendor (e.g., LabCorp), the account number for that specific location must be entered in the [Locations Manager tab](https://system/?f=chart&s=leditor&tabmodule=admin&tabselect=Locations+Manager) of the **Control Panel** for that location. When {{% system-name %}} sends the order electronically to the lab via the interface, that lab account number is sent with it. For more information, see the [Locations Management](../../features/system-configuration/locations-management.md) documentation.
{{% /info %}}
...
* [Advanced Search-Refer To of E-Orders](../../features/order-and-result-management/e-orders-refer-to-advanced-search.md)
* [E-Orders-Add Order Request](../../features/order-and-result-management/e-orders-add-order-requests.md)
* [E-Orders-Order Requests Chart Tab-Grid](../../features/order-and-result-management/order-requests-grid.md)
* [E-Orders Chart Tab](../../features/order-and-result-management/e-orders-chart-tab.md)
* [E-Orders View Recent](../../features/order-and-result-management/orders-view-recent.md)
* [Link Document to E-Order](../../features/document-management/documents-and-forms/link-documents-to-order-requests.md)
...
* [Observation Code Editor](../../features/order-and-result-management/observation-codes-editor.md)
