...
For more detail on user security role setting, see our [Security Role Settings](../../features/system-administration/security/security-role-settings.md) online help documentation.
...
Any additional details can be found in the [My Settings](../../features/system-administration/security/my-settings.md) online help documentation, if necessary.
...
* [Encounters-Adding-Creating Encounters](../../features/encounters/creating-or-adding-encounters.md)
...
* [Encounters-Archiving-Closing-ReArchiving](../../features/encounters/archiving-closing-re-archiving-encounters.md)
* [Encounters-Closing Dictation](../../features/encounters/dictation-and-transcription/closing-encounters-from-the-dictation-module.md)
* [Encounters-Editing Dictation](../../features/encounters/dictation-and-transcription/editing-encounter-dictations.md)
* [Encounters-Impression Section](../../features/encounters/symptoms-diagnosis-encounter-section.md)
...
* [Encounters-Protocols](../../features/encounters/encounter-protocols.md)
* [Encounters-Transcribing Dictation](../../features/encounters/dictation-and-transcription/transcribing-dictation.md)
* [Encounters-Worklist-Open Encounters](../../features/encounters/encounter-worklists.md)
* [Encounters Plan Section-Make Order Feature](../../features/encounters/make-order-feature-encounter-plan-section.md)
* [Encounters Plan Section-Meds](../../features/encounters/encounter-plan-section-medications.md)
* [Encounters Tab-Search and ListView](../../features/encounters/encounters-tab.md)
* [Link Documents to Encounters](../../features/document-management/documents-and-forms/link-documents-to-encounters.md)
* [Tests and Procedures-Adding-Applying-Completing-Resulting](../../features/encounters/tests-and-procedures-section-applying-adding-completing-resulting.md)
* [Tests and Procedures-Edit-Delete-Remove](../../features/encounters/tests-and-procedures-section-remove-delete-edit.md)
...
* [Encounter-EM Calculator](../../features/encounters/e-m-calculator.md)
