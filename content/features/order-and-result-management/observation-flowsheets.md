...
{{% note %}}
If the Date of Service on a Flowsheet Document is updated, the date/time of the observations within the document will be updated to match.
{{% /note %}}
