...
![](./print-definitions.assets/fff63c4ec0fdcfd7860721298c161ef2.png)

The Add Print Definition page will load. Fill in the appropriate fields to create the new print definition.

![](./print-definitions.assets/767f4555699bd014b52cc86f9a30407d.png)
...
![](./print-definitions.assets/2861252d78595e5c5141cb0e58234c10.png)

![](./print-definitions.assets/4e4b1e5429c67151af055a2cd2299f1e.png)
...
![](./print-definitions.assets/4aa397dcd7508e0469d06f407e9da476.png)
...
![](./print-definitions.assets/223a6bc8ab7a90d1f786eabd4efdf834.png)
...
![](./print-definitions.assets/d5f213466a078b94aac4afd75e611cd6.png)
...
![](./print-definitions.assets/d5601070aca4a84bfd58aade0c8ff8a7.png)

Once clicked, the *Edit Print Definition* page will load. Update the **Allowed Users** and/or **Allowed Departments**, as appropriate.

![](./print-definitions.assets/ffe8c4cf6986bedcbb8b0e53e3e3cf35.png)
...
![](./print-definitions.assets/066c8421ad33ce94e1e840a46ed6b707.png)
...
![](./print-definitions.assets/d3c54050542b765be8ccf96949c985c3.png)
...
![](./print-definitions.assets/f3d600a7ef9ea7537fddb8944c224734.png)
...
![](./print-definitions.assets/7fb175c4382273f84cbfd67f3d56fc3c.png)
...
![](./print-definitions.assets/4ad0cecfed67fdbf81a6a528b5234898.png)

The *Edit Print Definition* page will load, where any of the fields can be updated, as needed.

![](./print-definitions.assets/12a8868a30d787e230241146ee4be8d2.png)
...
![](./print-definitions.assets/ceee9a80f697cfb8e5c1e5a4f24f29bc.png)

## Delete Existing Print Definition

If a print definition is no longer used and needs to be removed from the system, rather than simply inactivating the print definition, users with the appropriate security permissions may delete it from the system.
...
![](./print-definitions.assets/cf19ccc1fb1115310589ac8b4f3680f6.png)
...
Navigate to the Print Definitions editor. All existing active print definitions will be displayed in alphabetical order. These can be filtered or searched, as needed. Locate the print definition needing a section added, and click the **Add Section** link in the *Actions* column.

![](./print-definitions.assets/d68c15e85492d32950ed13a7a83e7ed7.png)

The Add Print Section page will load. Fill in the appropriate fields to create the new section.

![](./print-definitions.assets/51998bc14aa3ecf68cb664ee70c36d14.png)
...
![](./print-definitions.assets/d29238a6309f8c3b65f5593c5567d100.png)

Once clicked, the print sections attributed to the print definition will be listed.

![](./print-definitions.assets/74a2499ce8219cd8020055a18f250cf8.png)
...
![](./print-definitions.assets/b892d5836d0afb402913c85e9ed45def.png)

When editing a section, users may change any of the section fields.

![](./print-definitions.assets/0f205b5919085d54ab325267ca447c9a.png)
...
![](./print-definitions.assets/df1b79b3867e4615db2c1cec37a0c768.png)
...
To begin, first navigate to the Print Definitions editor of the Control Panel. All existing active print definitions will be displayed in alphabetical order. Locate the existing print definition intended to be duplicated, and click the **Duplicate** link in the *Actions* column.

![](./print-definitions.assets/ee039d94af03f8e4840b19ce647bc533.png)
...
![](./print-definitions.assets/5ae8cfb2dabd21f2931c0d7fa39e215f.png)
...
![](./print-definitions.assets/e9b52cdebd247333623f939da44ae5c7.png)
