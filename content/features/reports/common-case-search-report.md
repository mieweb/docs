...
Capturing case (incident) detail on a patient or employee is done through encounters using the dynamic _Case_ section.

![](./common-case-search-report.assets/b24bade101cd2695a7fe963762dd03a8.png)
...
From the Reports sidemenu, there is a reports parent tab named _Safety._

![](./common-case-search-report.assets/62a7f194dc910d2803d964cc805e7765.png)

Within the parent report tab, there is a report hyperlink named _Incident Report_ or named _Case Report_. Clicking on that takes you to a report named _Common Case (or Incident) Search_. The report _Common Case Search_ is a report based on our hard-coded Incident report, but this _common case search_ layout (report) is customizable to include fields that you may want added to report.

![](./common-case-search-report.assets/5be413ba7801d702e6ceaee89d6a2ea6.png)
...
![](./common-case-search-report.assets/0d69af891cf71ecb713af4564e81570d.png)
...
![](./common-case-search-report.assets/42a9166274a93e09bbe761d3ffc991bb.png)

- This pulls from the field named <em>Select Case Type</em> that was captured in the case/incident section of an encounter.

![](./common-case-search-report.assets/8dbedd50d762daa87ff9ac110b2d9ea6.png)
...
![](./common-case-search-report.assets/028075f8872cb1a64b38e5c9c1db9e99.png)
...
![](./common-case-search-report.assets/6a968881d7f21c097574c08f62993d06.png)
...
![](./common-case-search-report.assets/b428079c1a9df69300484e98d0d91ada.png)
...
![](./common-case-search-report.assets/d4c6321382bcd9762705a27fb4756c19.png)
...
![](./common-case-search-report.assets/ae08d6a0b97459a88915231a5a834df7.png)
...
![](./common-case-search-report.assets/f0a21455bcc7f53b8ba78b5358f8104e.png)
...
![](./common-case-search-report.assets/720b31d2ca62637d4cc470f6ec057929.png)
...
![](./common-case-search-report.assets/0c28aed69fa97da8b5f68ea3ae226f8a.png)
...
![](./common-case-search-report.assets/5335ffda361c6cebabdd5291f18b80c4.png)
...
![](./common-case-search-report.assets/9315f76c2d005cbd7db15991c449e6f2.png)
...
![](./common-case-search-report.assets/7f217b16a59ff40bbe12c539bb669457.png)
...
![](./common-case-search-report.assets/3e547e201add05b7b26327324a68ff9a.png)
...
![](./common-case-search-report.assets/04691927345141c70459e12affcaf4ac.png)
...
![](./common-case-search-report.assets/2cf491ac352d5701d7e9ca40023955f0.png)
...
![](./common-case-search-report.assets/de3aac3b354da3020c6ae3f6957d71c2.png)
...
![](./common-case-search-report.assets/50719177efbef1b3df53b624705e885d.png)
...
![](./common-case-search-report.assets/3f0ecbc2e263834765df431439d0ef76.png)
...
![](./common-case-search-report.assets/ae94252bf8dcc9d86a41e90c12e0a16e.png)
...
![](./common-case-search-report.assets/ae342020e3e96ca50b46f97dda7981a4.png)

- If your system does have PPI and MMI enabled on your system, you will see those data input fields in the Case section of the encounter. Check the box for MMI and the Date field will display. Check the box for PPI and the Percent Impairment field will display. The Common Case/Incident Search report can be filtered by the MMI and/or PPI field.

![](./common-case-search-report.assets/b6fce24a196c54873e37770be417f2cf.png)
...
![](./common-case-search-report.assets/558de740e88185f092181ed365832128.png)
...
![](./common-case-search-report.assets/d2dec5a9806ee6faa83c8838de120992.png)
...
![](./common-case-search-report.assets/ec59fdfc58e2c431514a14c42513a413.png)
...
![](./common-case-search-report.assets/c02bc763888f869c2af1f2710eb43c51.png)
...
![](./common-case-search-report.assets/26722c8817915eda24f2b71a27daa97b.png)
...
![](./common-case-search-report.assets/2fac9783db70074434a95c9ee12f0c1b.png)

- <strong>Body Part:</strong> This is a dropdown filter field and is buildable, meaning you can run the report to give you results filtered by one or more specific body parts from the nature of the injury or illness.

![](./common-case-search-report.assets/57d13e1c6e7a9af4fc29c67312104056.png)
...
- <strong>Event of Exposure</strong>: This is an auto-complete search filter field. Our different Event choices available are listed here to run a report to filter by determination if needed.

![](./common-case-search-report.assets/6673d3b25137bfddeca95987c3c3d971.png)

- This pulls from the field named <em>Nature of Injury or Illness</em> that was captured in the case/incident section of an encounter. This is a field available in the Injury-(Non OSHA) case types by default. If you also wish to have this <em>Event</em> (and Source) data input fields in your Injury-(OSHA) case types, please contact your MIE Implementer to have that configured.

![](./common-case-search-report.assets/2411706058afcf93606fece7beaf1350.png)
...
![](./common-case-search-report.assets/e0199bc2411ca79bd25979d3dfcd2b65.png)
...
![](./common-case-search-report.assets/20390024eba61bc6701ee8a1fe1ef7fe.png)
...
![](./common-case-search-report.assets/f00560de16b84c9c390cd7f83956efb8.png)
...
![](./common-case-search-report.assets/ab70f65b12eeee43a4061e4e99aa8f5e.png)
...
![](./common-case-search-report.assets/3898ec674a1ae1ebfcb3c25aa55aff15.png)
...
![](./common-case-search-report.assets/af8cb4fd6ca70319c06d438528fa1df4.png)
...
![](./common-case-search-report.assets/3368abb23cfb359610c8b42e439b0eee.png)
...
![](./common-case-search-report.assets/41e9bc3e60a6a88bb7fe3f4a6812fb29.png)
