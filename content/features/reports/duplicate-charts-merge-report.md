...
![](./duplicate-charts-merge-report.assets/5175317e6774bdc4de18a74df3bffc61.png)
...
![](./duplicate-charts-merge-report.assets/a0f3b02688cdf07436ca07524448af58.png)
...
* <strong>"From" Partition(s):</strong> This option allows you to filter results based on a specific "FROM" partition(s). All partitions are included, even deactivated ones.
    ...
    * If no selection(s) in search criteria: Results from all applicable partitions are included, based on other criteria.
        * <strong>No-Part MR Partition Charts:</strong> This option determines whether No-Part MR charts are included in the results. All charts should be assigned a partition and MRNumber, but sometimes charts get inserted without those identifiers and are considered No-Part MR charts.  If No-Part MR is selected in the search criteria, the search results will include charts ‘from' those with no medical record number/MRN (No Part-MR).
...
![](./duplicate-charts-merge-report.assets/e79283c1e67928e02e7919361334acc9.png)
...
![](./duplicate-charts-merge-report.assets/386b172f9f78a95f8745f0014c689b02.png)
...
![](./duplicate-charts-merge-report.assets/b9fc99b1ff330ff8e75302b34ba3badd.png)
...
![](./duplicate-charts-merge-report.assets/2602ccbd755184ce63aab4bebe4130c9.png)
...
![](./duplicate-charts-merge-report.assets/e149843466851f81b9198eed6d227281.png)
...
![](./duplicate-charts-merge-report.assets/4e76a189ddd2c439cf77ae48c8fdd3b7.png)
...
![](./duplicate-charts-merge-report.assets/495bd241e41d8e8838274412b53fef86.png)
...
![](./duplicate-charts-merge-report.assets/a987b6800aed65a8df17d1de1d243093.png)
