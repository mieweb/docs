...
Select the _Access_ tab from the top tab menu and click on _Activity Log_ (or access it through the Reports tab).
...
After you copy the entire string with your mouse, click CONTROL and N keys on your keyboard to open a _new window_ on your computer screen. At the top of the new window that opened up on your computer, type in a question mark **?** at the **end** of the url that shows there. Then after the **?** question mark, right click and _paste_ in the cgi query string you copied.
