...
Click _E-Chart_ tab from left sidebar menu.

Search and get into the file for the patient you need to cancel or no show an appointment for. When in their chart, click the _appointments_ tab in the above chart tabs.
...
![](./cancel-no-show-edit-appointments.assets/7af67dcfde0a116c3fd03009ddf16121.png)

![](./cancel-no-show-edit-appointments.assets/3493b51d34bdf3792712625b3369e181.png)
...
Scroll down towards the bottom of this Reschedule/Cancel Appt screen and there is a button _Cancel_ under the comments section.
...
If you have security role permission, you may see the _New Reason_ selection from the drop-down choices. If you have security rights, you can add another cancel reason to the list if you don't find a cancel reason that is suitable for the reason you are canceling this appointment. Simply highlight and select _New Reason_ from the drop-down.

![](./cancel-no-show-edit-appointments.assets/f3d78086b775793f31d62b70b11bc190.png)

It will then open the ADD CANCELLATION CODE window. Enter the fields to add a new cancellation reason to the list.

![](./cancel-no-show-edit-appointments.assets/f67ece839c4bab87be612fd23a775ecb.png)
...
If you have security rights, you can manage/add/edit/delete existing cancellation codes from the _Cancellation Codes_ top tab from within the Scheduler module.

![](./cancel-no-show-edit-appointments.assets/0270fcc0442a21c329e90131b2a8d037.png)
...
Click _Scheduler_ tab from left sidebar menu.
...
![](./cancel-no-show-edit-appointments.assets/f219fe0d689286983572866e80b5d101.png)
...
Otherwise, in any schedule view (list, multi, or weekly) click the link _Cancelled_ on the top, right side of the List or Multi or Week scheduler view.

![](./cancel-no-show-edit-appointments.assets/fa0a69ccf5781f915be56969d52d10f8.png)
...
![](./cancel-no-show-edit-appointments.assets/f06eec98ff0174bffe8c78f76e8b55a0.png)
...
![](./cancel-no-show-edit-appointments.assets/5698a7d084847a82aa4ae9d6acf24e21.png)

The appointment will open on your screen. Scroll down toward the bottom to the _Cancel_ field. It will show the reason the appointment was cancelled.

![](./cancel-no-show-edit-appointments.assets/f6995a3cd52681c40127ce2d7f4f78da.png)

Change the _Cancel_ field drop-down and select the very first choice that is totally blank. This will reverse the cancellation of the appointment and clear out the cancel reason field for the appointment. Then click the SAVE button when done reversing the cancelled appointment to make active again.

![](./cancel-no-show-edit-appointments.assets/306b4ce3224d306b3a11d6156342c64f.png)

Once you've cleared the _Cancel_ field drop-down and clicked SAVE button, it will refresh your screen to that day's schedule and show/place that re-activated appointment back on that day's schedule of appointments.

![](./cancel-no-show-edit-appointments.assets/f3ca05aa0cbf5ff4207ccf1adf4bc519.png)

You can also reactivate a cancelled appointment from the patient's chart in their Appointments chart tab.

Find the cancelled appointment bucket in that specific patient's medical record. Click the _edit_ link for that cancelled appointment. Then follow the same steps above to change the _cancel_ field to be "clear" and it will reactivate the appointment to be back to its original date/time it was scheduled for.

![](./cancel-no-show-edit-appointments.assets/55980775fae3ec98ebd666ff0b93eaf1.png)
...
You can find an appointment for a patient by clicking _E-Chart_ on left side bar, then searching for patient. After find the patient, click their chart tab called _Appointments_.

Click Edit on the appointment that you need to copy.

![](./cancel-no-show-edit-appointments.assets/99746c71403928e84f9176bd84204553.png)

It will open the appointment wizard screen.

In the appointment wizard, scroll down and click _COPY_ button.
...
However, make changes by selecting a new appointment date/time for this copied appointment, and made any other changes you wish, click _SAVE_ button to add and save that new appointment you created from a copy.
...
Click _E-Chart_ tab on left sidebar menu.

Search for patient and open their chart.

After find the patient, click their chart tab called _Appointments_. The patient's past/pending, cancelled and/or no show appointment categories and listings will show.
...
When done, click the _SAVE_ button at the bottom of the screen.

![](./cancel-no-show-edit-appointments.assets/1ead52c280ba78b81d72239979e93d80.png)

After you click _SAVE_, it will then pop-up to the scheduler view and show you the appointment as you have edited it.
