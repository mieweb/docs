...
A list of configured departments can be viewed by clicking on the *Control Panel* sidemenu tab and then within the *Access Control* tab at the top.  It will display an alphabetical list of the department names that exist in your {{% system-name %}} system.

![](./managing-departments.assets/7090c10046a4768bae2f4e6346593e11.png)
...
![](./managing-departments.assets/3cb05ea34da92059db138aedcdbebcb1.png)
...
![](./managing-departments.assets/e4dc3c1422ef253f583fb4c50166c836.png)

When you click Add Department, the Add Department screen fields will display.

![](./managing-departments.assets/f6082c5232a9ce3286a6af3c937d75ad.png)
...
![](./managing-departments.assets/1b880bd41ce001fe6ff0dab2af2f8141.png)

## Options

Within the listing of departments, there is an Options column.

![](./managing-departments.assets/ed1b26e432010af59af3999e6b82c016.png)

* <strong>Revisions:</strong> Revision history is available to view and applies to the department name only.  Meaning, revision history tracks any changes to the department name itself and when a department is created or marked deleted.

![](./managing-departments.assets/c8b0c24a245d69c7ecb9ec18cf8e132d.png)

* <strong>Edit:</strong> Allows editing a department name and/or managing users tied to the specific department.

![](./managing-departments.assets/b2805cd5e7149dc354e280f3e2b90a15.png)

* <strong>Delete:</strong> When clicking the <em>delete</em> option, the system will ask you to confirm if you would actually like to delete the department.
    * NOTE: There may be existing users linked to the department you are wanting to delete.  Deleting a department, does <strong>not</strong> remove existing users from being linked/tied to that department.

![](./managing-departments.assets/9790ea6128435bd2d7d0844d8e626470.png)
...
![](./managing-departments.assets/a32a25686e70ed4a7e0097e9fad8ebc2.png)
...
![](./managing-departments.assets/3cfb840d4431eb7c8a77adf1ca7ae5a4.png)
