...
Users must have security access to be in the Health Surveillance Panel editor. On the sidemenu tab, click the CONTROL PANEL tab. Once in the Control Panel tab, find (in the listing) _Health Surveillance_ **or** click the HSP tab at the top menu of tabs.
...
If you wish to see any panels that are _inactive_, simply click the Show Inactive link in the title Panels at the top.
...
It will pop-up a window to the _Edit Panel_ with the fields you can edit.
