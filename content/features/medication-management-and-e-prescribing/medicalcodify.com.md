...
## Where can access Medical Codify
...
![](./medicalcodify.com.assets/ad7e9fee0ef00569e14290afa7a9a1e5.png)

### Medication Information via Allergies/Medications Chart Tab

From the Allergies/Medications tab within a specific chart, any coded medication will offer an (i) info icon.

![](./medicalcodify.com.assets/3c7d49dd00b6c4f2617daca7d0a6fafa.png)

Clicking the (i) icon on a coded medication, will advance the user into the detailed information regarding that drug with its known ID and various other information to be accessible in one screen.

![](./medicalcodify.com.assets/8c29019efd9d72da83dfb4b899b71809.png)

### Medication Information via Encounter Data

In various areas of an encounter, any coded medication will offer an (↗) info icon. Clicking the (↗) icon on a coded medication, will advance the user into the detailed information regarding that drug with its known ID and various other information to be accessible in one screen.

![](./medicalcodify.com.assets/0622386a8470074e5dbe9ba975100a71.png)
...
## How to use Medical Codify

Our Medical Codify search tool is easily used by a simple term or code search method, or through an Advanced Search method.

### Simple Search

To begin, simply search for a term or code in the search bar at the top of the MedicalCodify.com page.

![](./medicalcodify.com.assets/a0464f17e1b066d6796e668483cec99c.png)

It then results in any matching selections and once a selection is clicked, it will advance you to its detailed information.

![](./medicalcodify.com.assets/64c48fcff67e777c2f7403e23cb3332e.png)
...
Example of advanced search by an icd10 code and accessing detailed Snomed information:

![](./medicalcodify.com.assets/abbea91c2b7b4fcd9c4577ea99ad987d.png)
