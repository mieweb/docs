...
links: []
source: 'https://drive.google.com/open?id=1kUr10Gkypu2y1hD48gN3ImkwmwkGdOS2nyBVOV4Uu_A'
wikigdrive: 'v2.16.0'
---
Ozwell AI - Overview
...
1. Click on the AI button at the top of the screen to open Ozwell AI. The Security Setting "Enable AI Assistant" must be set to "Yes" to access Ozwell AI.

![](./ozwell-ai-overview.assets/d026ce1f86373f195a8370f8c38149a8.png)

![](./ozwell-ai-overview.assets/1efb6751cc8fe660875a21a2d4030658.png)

2. Click the Gears icon to open Settings. You may see options such as Referrals and Billing. Those options should be ignored.

![](./ozwell-ai-overview.assets/7703d7389ddca2b46af5300d376b2790.png)

![](./ozwell-ai-overview.assets/d429aed000e47e401991b8181039d21f.png)

3. Update the relevant settings. This may include name, job title and/or custom instructions. Custom instructions allow you to tell Oswell how to handle specific scenarios (e.g., always send work status notes to a specific person, suggest wellness programs, require consent for recording). Custom instructions are per user. If rolling out to multiple users, share the instructions for them to copy and paste. You can also toggle condensed chat and change your language preference.

![](./ozwell-ai-overview.assets/548245fe6252343fa903559eb7bec886.png)

4. After making your changes, click the Save button.

![](./ozwell-ai-overview.assets/d4ad1101cad9675b2927d0a32d1e20fb.png)
