...
wikigdrive: 'v2.16.0'
---
Users must have security access to be in Health Surveillance Management control tab. On the sidemenu tab, click the CONTROL PANEL tab. Once in the Control Panel tab, click the HSP tab at the top menu of tabs and then click on Health Surveillance. Once in the Health Surveillance module, click on the Legacy Editor link.

![](./export-import-health-surveillance-panels.assets/a0e0d269937192b64b678b174da610a3.png)

![](./export-import-health-surveillance-panels.assets/5b4d06d913066b7e5885ddeeff9af054.png)
...
![](./export-import-health-surveillance-panels.assets/9fe34d2969bbd2899c80ac004c905ca5.png)
...
![](./export-import-health-surveillance-panels.assets/1488cbfa5d89910c3c21a47eff1ab53d.png)
...
![](./export-import-health-surveillance-panels.assets/2ae7c1e1b5268a17dc503ea2fe27b6cd.png)
...
![](./export-import-health-surveillance-panels.assets/52360e022f11d93886050f0905149033.png)

Within the blank text field you will click your mouse, then right click and select *"paste"* (or Control and the V key).

![](./export-import-health-surveillance-panels.assets/e28cd5a05b7a0aaf4c9180b8a8770bc5.png)
...
![](./export-import-health-surveillance-panels.assets/eac33959415e04b82b64ceddececdc8b.png)
