...
You can add a partition by selecting _Add Partition_ link from the top right corner.
...
{{% info %}}
_If a partition is "Hidden From View" or non-active, it will not be shown in the Partition Membership section in the View User(name) screen._
{{% /info %}}
