...
The patient can view the corresponding canned statement on the Topaz device screen and clicks _Tap to Continue_.
...
The signature is captured and considered complete. If the patient forgot to do this, the clinician or administrative user can click the _Save Signature_ button on the {{% system-name %}} screen to save/upload it.
...
Once the patient clicked OK after signing, or the clinician clicked _Save Signature_, the document is stored to the appropriate selected chart.
