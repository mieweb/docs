...
You must have security role of _Manage Custom Pharmacies_ set to Yes to access the Custom Pharmacy tab found in the Control tab module.
...
The editor for setting up a dispensing machine to receive these electronic prescriptions and allow that in-house dispensing machine be set as a patient's preferred pharmacy is the tab named _Custom Pharmacy_ which is found in the sidemenu tab named Control.
