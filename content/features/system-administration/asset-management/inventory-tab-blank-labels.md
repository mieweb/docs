...
![](./inventory-tab-blank-labels.assets/af1186796c81b63d472d4f8f1ab29121.png)
...
![](./inventory-tab-blank-labels.assets/bc91db3a28f7ddae50afaa74cc6a74ed.png)

It will then show a print preview on your screen and you need to click the PRINT button to print the label on your special label paper & printer. You can print multiple of these ‘blank' labels if you wish. The Blank Labels feature is configured for a Dymo label printer. Orientation of the label (in portrait or landscape) can be programmed by MIE in the layout.
