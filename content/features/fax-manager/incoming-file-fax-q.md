...
2. Select yourself, a different user, security role or system wide and click the "View" button to enable the new queue.

![](./incoming-file-fax-q.assets/776d644d5d8b538fde98fedb097cb0ee.png)

3. Update the New Fax Q setting to Enabled

![](./incoming-file-fax-q.assets/430dba918f301d191db8048b3a2b6c3c.png)

4. Click the "Submit Settings" button

![](./incoming-file-fax-q.assets/9be321e53d95bf57a253fc8edafb1c7f.png)

5. From the <em>Control Panel</em> on the left side menu, click on the <em>System</em> chart tab and then click on the <em>Menu Editor</em> sub-tab

![](./incoming-file-fax-q.assets/590cf07f3aeadbac15b78a4c3f21cc71.png)

6. Click the <em>Add Menu Item</em> link in the right corner

![](./incoming-file-fax-q.assets/5bdfb072cc35856acc61465c9f720ac0.png)

7. Click on the drop-down for <em>Module</em> and select <em>sidemenu</em>

![](./incoming-file-fax-q.assets/2cc4011603178e0a987170e217794100.png)

8. Add the <em>Name</em> for the sidemenu item (<em>File Queue</em>)

![](./incoming-file-fax-q.assets/92c45086775fb93a911771403a4947d5.png)

9. Add the <em>URL</em> - ?f=layout&module=SystemReport&name=IncomingFileQueue&tabmodule=+

![](./incoming-file-fax-q.assets/3cc50680a55acb2c59639a93aa740a1f.png)

10. Add the <em>Target</em> of <em>mainwindow</em>

![](./incoming-file-fax-q.assets/460d939aa2d2e01cf6ddc0750008778f.png)

11. Click on the <em>Tab Order</em> drop downs to set where the New File Q option will be located on the sidemenu

![](./incoming-file-fax-q.assets/3e83cb64ec006f3d7cfbee3f371d8025.png)

12. Click the checkbox for <em>Show in Webchart</em>

![](./incoming-file-fax-q.assets/018bd26f7fb2f80b47298f23215ca594.png)

13. Click the "Add" button

![](./incoming-file-fax-q.assets/377873a5c08a3f860445e3aaad81b7c3.png)

14. After a screen refresh, the new sidemenu tab for the File Queue will display
...
![](./incoming-file-fax-q.assets/d7ef1b779890294953fdfd6407f2439b.png)

### Categories

1. Click the <em>Categories</em> link in the top right corner

![](./incoming-file-fax-q.assets/3e6def88db56ed4b70688496a9b0cc6c.png)

2. Click the <em>Add Category</em> link in the top right corner

![](./incoming-file-fax-q.assets/35cb892f2c64c51054961953489ab6c2.png)
...
![](./incoming-file-fax-q.assets/6124a3569cc710dec20668538e05554e.png)

2. Click the <em>Mapping</em> link in the top right corner

![](./incoming-file-fax-q.assets/ce988b528801cf520a259860ff9a699c.png)
...
![](./incoming-file-fax-q.assets/456d2d4981bb0bcfc0fe6076ab601088.png)
...
![](./incoming-file-fax-q.assets/fcaa9367e7aa1313942803e092a54017.png)

2. Add a <em>Description</em> for the task

![](./incoming-file-fax-q.assets/3a49fad28ae8c389c81516024a7faf28.png)

3. Add a <em>Start Date</em> and <em>Due Date</em>

![](./incoming-file-fax-q.assets/532813117e937d08f0db4030ad55c5d0.png)

4. Select the <em>Owner(s)</em>. This can be either a Department or User.

![](./incoming-file-fax-q.assets/038dac175a7514eed88f94ce6ff27184.png)

5. Select a <em>Priority</em>, if needed

![](./incoming-file-fax-q.assets/342ba00e4e591c16a637aed63fbfc20c.png)

6. Add any Notes, if needed

![](./incoming-file-fax-q.assets/9b78d8fe2f23bf45a070d821650ae4a2.png)
...
![](./incoming-file-fax-q.assets/c76eaddad3eb2bab32fb7006271bfdbe.png)

2. Go to Webscan to then index the batch by clicking <em>Open</em>
...
![](./incoming-file-fax-q.assets/097119ca75dc3a1b544dfcefed6e1df6.png)

2. The batch is created and instead of going to Webscan, the index page automatically pops up

![](./incoming-file-fax-q.assets/48ae29b43b0d84c5cbc08ded46d7dbc9.png)

### Open File

1. Click <em>Open</em> and the file will open in a new window

![](./incoming-file-fax-q.assets/3d71e01b52138fe50d205deaa9eb8979.png)

2. In the new window, at the top of the screen, summary information displays. The summary includes the File ID, Date and Time it was created in the queue, the Sender's fax number, and the status.
...
![](./incoming-file-fax-q.assets/fe07b6a450346bcd1ef4daa3d92868dc.png)
