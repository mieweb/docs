...
When you click the picklist icon, it opens the default order picklist set within the Encounter Type configuration, or the order picklist that is set in your My Settings picklist, which typically is a picklist named _In House Testing_.
