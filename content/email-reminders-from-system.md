...
url: "email-reminders-from-system.md"
author: Alan Quandt
...
![](external_files/88524771809e93942165bfccf5ecafcd.png)

The email link is also available in the scheduler views to send mass email reminders for the appointments scheduled for the day/view you are viewing. This is a user preference if Scheduler Preference *Show Email Link* is set to Yes. See other help documentation named [Scheduler Views-List-Multi-Week](scheduler-views.md) for specifics on how to email from the scheduler views. Also from the scheduler view you can send an individual patient email reminder on the specific appointment scheduled on the view.

![](external_files/d8f62e070c9c3d077ab7424f3583bfe0.png)

The email link is also available to send mass email reminders within the Appointment Report in the reports tab. See other help documentation named [Appointment Report](appointment-report.md) for specifics on how to email from the Appointment Report screen.

![](external_files/2a3488c5ae7c086a5683f16d6fb4c79f.png)

The email link is also available in the Wizard tab to send an email reminder for new appointments being scheduled. See other help documentation named [Adding An Appt Using Wizard Tab](adding-an-appointment-using-the-wizard-tab.md) for specifics on how to email from the Wizard (adding appointment) screen.

![](external_files/c38268232964a85e026e35c2b45da31a.png)

The email link is also available to send email reminders within the Waiting List tab of the scheduler. See other help documentation named [Waiting List Tab](waiting-list-tab.md) for specifics on how to email from the Waiting List screen.

![](external_files/5994b65422cc9c6ad1e3a65c6cf6ad0d.png)
...
![](external_files/f0fac98fb7f0366abac742b35df1e2cb.png)
...
![](external_files/c4bd9b29f48d28e815c19468ff91c06b.png)
...
![](external_files/b444a47210bd8711c2e49217a9606235.png)
...
![](external_files/97dcda3b31a9f2542ac95f8fd3853e69.png)

This is what the Comments Only email template looks like when it sends to the patient:

![](external_files/3f36e3068de2772e1d7ccc0249a0c7ed.png)
...
![](external_files/c6378186d8931063c7da7d5e4260348d.png)
...
![](external_files/48b24ddc7210a3fd7d5c64a4afa36efd.png)
...
![](external_files/69d26c4612b7afbedf0ae933ff595617.png)

Click the preview link to view a preview of the email contents that will be sent out.

![](external_files/348f53708ce579fc7022efa6e72cbd57.png)![](external_files/e2d44556792c5e65c74d1331b40ad8f6.png)
...
* <strong>Carbon Copy Email:</strong>  ![](external_files/4bf70d1d6be932c452e09f031e558fb8.png) 
...
![](external_files/c93222147d04aa77f2c56bc8b797354a.png)
...
![](external_files/6052bb74bb38df99ec2e034138624e5e.png)
...
![](external_files/e812eb59338a139e9796f7923f6ef2c3.png)

This is what a Default email template looks like when it sends to the patient:

![](external_files/3541e7cc3d732dc5727d0866d3adbeff.png)
...
![](external_files/31b35bfe0eafbb3c8c514e0584c2933c.png)
...
![](external_files/50535dc04bc83e2651c387f50de91b9a.png)

These email documents can also be found using the Doc Report (Document Report). This Document Report is found in the Reports sidemenu tab. You can search for emails using that report. *See other help documentation named *[Documents Report-Super Doc Search](documents-report-super-document-type-search.md).
...
![](external_files/c52536973f54e4f6a9e84794b773c335.png)
...
![](external_files/f582284dadae9c32f3427a7deee2d610.png)
...
![](external_files/c5a5ba4e8697a95bc28f424adde6de08.png)

![](external_files/fe2ee3f227725788bea2c6c8fef9e9a5.png) ![](external_files/ff28586a8211f28a01afde7d26451e5d.png)
...
![](external_files/edb1af95a12ea2c902f3f784cca085c7.png)
...
![](external_files/75e85ccde41f0b8b8a3a20e4e382daf8.png)
