...
url: "review-session-medication-management-electronic-prescribing.md"
author: Alan Quandt
...
![](external_files/2698d6842f3825fc026617fac21332fc.png)
...
* First, set the <strong>Current Library</strong> to the appropriate alternative that will be the library the prescription will be associated with and remembered under.
* Click the <strong>Prescribe</strong> link, to begin adding a prescription.
* In the <strong>Medication</strong> autocomplete field, begin typing and select the medication name. It is important not to overwrite a saved or remembered prescription. To avoid overwriting a saved prescription, use medications notated with <strong>(New)</strong>. Selecting a (New) choice will prompt users to fill out each field.
...
![](external_files/3676ee4b02f9d7fe2fe2f46f751641fa.png)
...
![](external_files/041f37725e79972230faeaabde0de906.png)
...
![](external_files/cb27add77c7ff4fd7948b93be28d50ec.png)
...
![](external_files/4393778a1ccae3610fc383221de4b6aa.png)

* Once the request is processed, a reply to the task will be provided, and a SureScripts Prescriber ID (SPI) will be assigned to the provider. Always check the provider prior to notifying the client. ![](external_files/229755f89b4b14796a2bccb9a24e3ac0.png)
...
* Navigate to the [Access Control tab](https://system/?f) of the <strong>Control Panel</strong>.
...
{{% info %}} If the prescribing clinician is new to {{% system-name %}} , click the [Add User link](https://system/?f=admin&t=security&tabmodule=admin&tabselect=Access+Control&opp=auser&realm), to add the user/provider to the {{% system-name %}} solution. See [User/Provider & Department Management](user-provider-and-department-management.md) for more information on adding users/providers. {{% /info %}}
...
{{% info %}} Nurse Practitioners (NPs) and Physician Assistants (PAs) may be signed up to use SureScripts; however, a blank space must be entered into the DEA Number field using the space bar key. Upon submission, a reminder will be triggered about the required field. Simply acknowledge the reminder and continue to submit the page. **A valid NPI Number is still required for NPs and PAs to be certified with SureScripts**. {{% /info %}}

* Locate the <strong>Electronic Prescriber</strong> checkboxes. These selections are intended for prescribers, only (i.e., users holding a National Provider Identifier (NPI) number, and/or DEA Registration number, and are legally allowed to prescribe). Place a check mark in the appropriate checkboxes:
...
* Verify the prescriber is a member of the Prescribers Department, as described above.
* When all required fields are entered and the appropriate electronic prescriber boxes checked, click the <strong>Submit Edit</strong> button (or <em>Submit Insert</em> button, if a new user is being created).
...
![](external_files/cb75add6384b206406b6cd9381eba2d1.png)
...
![](external_files/56de4564f91902e7fbbad2c9807e9b60.png)
...
![](external_files/b9e7a1e99185632b2a981c8e0c827e7a.png)
...
* Click the [Access Control](https://system/?f=admin&t=security&tabmodule=admin&tabselect=Access+Control) tab.
* Set the physician/user to <strong>Login Disabled</strong>.
* Deselect, or un-checkmark, <em>both</em> <strong>Electronic Prescriber</strong> checkboxes.
    * Send New Scripts
    * Receive Refill Requests
* At the very bottom, click the <strong>Submit Edit</strong> button.
...
![](external_files/d3cbe25bcde59636bf7f8151bbd6519a.png)
...
* [Discontinue Meds](discontinue-medications.md)
...
* [Edit or Change Meds](edit-change-medications.md)
* [Flow-Pat Ed-Meds Sheets](allergy-medication-tab-quick-links.md)
* [Formulary and Dosing-SureScripts Advanced](surescripts-advanced-formulary-and-dosing.md)
* [Medication History Reconciliation-SureScripts Advanced](surescripts-advanced-medication-history-reconciliation.md)
* [Meds Library-Remembered Scripts](remembered-prescriptions-and-meds-library.md)
* [Meds Tab Summary View](allergies-medications-tab-summary-view.md)
* [Preferred Pharmacy-Supply-Verification-Current Library](setting-preferred-pharmacy-days-supply-and-current-library-and-med-history-verification.md)
* [Prescribing and Adding Meds](prescribing-adding-medications.md)
* [Prescription and Insurance Eligibility Requests-SureScripts Advanced](surescripts-advanced-prescription-and-insurance-eligibility-requests.md)
* [Print-Fax-Transmit Prescriptions](print-fax-transmit-prescriptions.md)
* [Refill All Meds](refill-all.md)
* [Setting up E-Prescribers](setting-up-e-prescribers.md)
* [Unknown Allergy or Medication Add Email Notifications](unknown-allergy-medication-email-notifications.md)
