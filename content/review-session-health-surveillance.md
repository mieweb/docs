...
url: "review-session-health-surveillance.md"
author: Alan Quandt
...
A panel consists of a list of tests, procedures, or other services expected to be performed per exam. As stated, these items are known as [Panel Actions](health-surveillance-panels-actions.md), and they can be configured with specifications, or parameters, which are known as *action rules*. Action rules determine when the actions should be triggered, or considered due; or they may trigger a notification of the panel needing to be completed via a portal, tasking, or email, depending on the system configuration. Rules may also require the presence of certain things (e.g., only trigger if the individual is male, perform only as a vaccine series), or include a multitude of various other complexities, not to mention whether the action(s) is/are being performed as an entry panel, routine panel, or exit panel.
...
* [Health Surveillance Panels-Add Individual Manual Membership](health-surveillance-panels-add-memberships-manually.md)
* [Health Surveillance Panels-Adding and Editing](adding-editing-health-surveillance-panels.md)
* [Health Surveillance Panels-Automated Membership](health-surveillance-panels-automated-membership.md)
* [Health Surveillance Panels-Completed Orders Import Tool](completed-orders-import-tool.md)
* [Health Surveillance Panels-Export-Import Panels](export-import-health-surveillance-panels.md)
* [Health Surveillance Panels-Introduction](introduction-to-health-surveillance-panels.md)
* [Health Surveillance Panels-Panel Definition Report](panel-definition-report.md)
* [Health Surveillance Panels-Panel Membership Import Tool](panel-membership-import-tool.md)
* [Health Surveillance Panels-View Membership](viewing-health-surveillance-panels-and-membership.md)
* [Panel Action Evaluator](panel-action-evaluator.md)
* [Respirator Info-Chart Tab](respirator-info-chart-tab.md)
* [Work Regions-Work Location tab](locations-management.md)
