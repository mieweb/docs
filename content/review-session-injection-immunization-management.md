...
url: "review-session-injection-immunization-management.md"
author: Alan Quandt
...
For more information about injections, adding vials, and the injection tab, generally, review the [Injection Tab](injection-tab.md) and [Vials](injection-tab-vials.md) documentation.
...
For additional information regarding the Injection/Immunization module, its various categories, and its general features, see the [Injection/Immunization Management](injection-immunization-management.md) index.
...
For more information on the Mass Injection Program, review our [Injection Program Tab](injection-program-tab-recording-mass-injections.md) documentation.
...
* [Injection Tab-Edit-Delete](edit-delete-injections-immunizations.md)
